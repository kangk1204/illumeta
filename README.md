...
<p align="center">
  <a href="docs/assets/readme_dashboard_gse125605.png">
    <img src="docs/assets/readme_dashboard_gse125605.png" alt="IlluMeta GSE125605 analysis dashboard preview." width="980" />
  </a>
</p>
<p align="center"><em>Run example: GSE125605 analysis dashboard (static preview of IlluMeta interactive HTML output).</em></p>
...
<details>
<summary><strong>Important notes before installing</strong></summary>
...
|------|---------------|---------------|--------------|
| 1⃣ | **Quality Control** | `QC_Summary.csv` | >90% samples pass |
| 2⃣ | **Batch Effects** | Dashboard "Batch" section | Reduced after correction |
| 3⃣ | **Lambda (inflation)** | Dashboard header | λ ≈ 0.9 - 1.1 |
| 4⃣ | **DMP counts** | Dashboard summary | Depends on your study |
| 5⃣ | **Top hits** | `*_Top_DMPs.html` | Biologically relevant genes |
...
<details>
<summary><strong>I got very few (or zero) significant DMPs. Is something wrong?</strong></summary>
