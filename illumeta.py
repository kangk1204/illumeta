...
""")
    ...
    run_docs = [
        ...
        ("Correction_Diagnostics_Report.txt", "Correction Diagnostics Report", "CDx summary for the primary branch.", "DOC"),
        ("Correction_Diagnostics_Summary.csv", "Correction Diagnostics Summary", "CDx metrics for the primary branch.", "CSV"),
