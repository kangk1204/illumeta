...
- Generated: 2026-05-21 23:14:43
- Config: `/home/keunsoo/Projects/23_illumeta/.omx/team/reframe-the-illumeta-203c3847/worktrees/worker-1/projects/GSE66351/configure_AD_vs_CTRL_neuron.tsv`
- Output: `projects/GSE66351/AD_vs_CTRL_neuron_occipital_results_direct_run5_tier3skip`
- Groups: control=`CTRL` (n=16), test=`AD` (n=15)
- Tissue: `DLPFC` (source: config:text_heuristic)
...
- Sesame cell composition: RefFreeEWAS (Sesame).
...
- Lambda guard (primary): status=ok, action=warn, threshold=1.500, lambda_guard_lambda=NA.
