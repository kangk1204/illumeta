...
- Generated: 2026-05-21 23:08:44
- Config: `/home/keunsoo/Projects/23_illumeta/.omx/team/reframe-the-illumeta-203c3847/worktrees/worker-2/projects/GSE66351/configure_AD_vs_CTRL_neuron_occipital.tsv`
- Output: `projects/GSE66351/AD_vs_CTRL_neuron_occipital_results_worker2_minfi_vp0_limmavp0`
- Groups: control=`CTRL` (n=16), test=`AD` (n=15)
- Tissue: `DLPFC` (source: arg)
- Array type detected: 450K
...
- Cross-reactive probes: removed using list (n=38638). References: Pidsley 2016; McCartney 2016; Chen 2013.
...
- CRF sample tier: moderate (total_n=31; min_per_group=15).
...
- Primary inference mode: unknown (tier3_batch=none).
- Tier3 meta-analysis (primary): method=fixed, I2_median=NA.
- Lambda guard (primary): status=unknown, action=unknown, threshold=NA, lambda_guard_lambda=NA.
- DMR status (primary): unknown.
- Sesame dye bias normalization: skipped.
...
- Total_samples_input: 31
- Samples_failed_QC: 0
- Samples_passed_QC: 31
- Samples_failed_sex_mismatch: 0
- Sex_mismatch_samples: 0
- Total_probes_raw: 485512
- Probes_cross_reactive: 38638
- Probes_final: 420309
